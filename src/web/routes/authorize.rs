use crate::Result;
use crate::client::{GoogleOAuthClient, RequestAccessTokenExtraParams};
...
struct RequestAccessTokenQuery {
...
pub async fn authorize(
    ...
    query: web::Query<RequestAccessTokenQuery>,
) -> Result<HttpResponse> {
    let response = oauth2.request_access_token(&query.extra_params);
