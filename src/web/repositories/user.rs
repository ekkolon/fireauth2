...
use crate::{Result, impl_actix_from_request, models::user::GoogleUser};
...
impl GoogleUserRepository {
    pub fn new(db: FirestoreDb, collection_name: impl AsRef<str>) -> Result<GoogleUserRepository> {
    ...
    pub async fn get<ID: AsRef<str>>(&self, id: ID) -> Result<Option<GoogleUser>> {
...
impl_actix_from_request!(for GoogleUserRepository);
